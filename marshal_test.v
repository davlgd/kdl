...
fn test_schema_errors() {
	...
	expect_schema_error[Wrap[BadArgType]]('inner.a: the `arg` tag does not accept a array field')
	...
	expect_schema_error[Wrap[BadOptionArg]]('inner.a: the `arg` tag does not accept a option field')
